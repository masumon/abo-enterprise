...
INSERT INTO reviews (customer_name, company, rating, review_en, review_bn, source, is_verified, is_featured, is_active, photo_url)
SELECT 'Rahim Uddin', 'Shop Owner, Sylhet', 5,
...
INSERT INTO reviews (customer_name, company, rating, review_en, review_bn, source, is_verified, is_featured, is_active, photo_url)
SELECT 'Fatema Begum', 'Restaurant Owner', 5,
...
INSERT INTO reviews (customer_name, company, rating, review_en, review_bn, source, is_verified, is_featured, is_active, photo_url)
SELECT 'Karim Hassan', 'IT Manager', 5,
...
INSERT INTO reviews (customer_name, company, rating, review_en, review_bn, source, is_verified, is_featured, is_active, photo_url)
SELECT 'Nusrat Jahan', 'Freelancer', 5,
