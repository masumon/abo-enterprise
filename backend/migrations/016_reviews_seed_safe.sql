...
-- Must set id, created_at, and updated_at explicitly.

INSERT INTO reviews (id, created_at, updated_at, customer_name, company, rating, review_en, review_bn, source, is_verified, is_featured, is_active, photo_url)
SELECT gen_random_uuid(), NOW(), NOW(), 'Rahim Uddin', 'Shop Owner, Sylhet', 5,
...
INSERT INTO reviews (id, created_at, updated_at, customer_name, company, rating, review_en, review_bn, source, is_verified, is_featured, is_active, photo_url)
SELECT gen_random_uuid(), NOW(), NOW(), 'Fatema Begum', 'Restaurant Owner', 5,
...
INSERT INTO reviews (id, created_at, updated_at, customer_name, company, rating, review_en, review_bn, source, is_verified, is_featured, is_active, photo_url)
SELECT gen_random_uuid(), NOW(), NOW(), 'Karim Hassan', 'IT Manager', 5,
...
INSERT INTO reviews (id, created_at, updated_at, customer_name, company, rating, review_en, review_bn, source, is_verified, is_featured, is_active, photo_url)
SELECT gen_random_uuid(), NOW(), NOW(), 'Nusrat Jahan', 'Freelancer', 5,
