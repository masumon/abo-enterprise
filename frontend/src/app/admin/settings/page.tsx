...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "contact_hours_en", label: "Business Hours (EN)", placeholder: "Sat–Thu, 9:00 AM – 8:00 PM", hint: "Shown on homepage contact section" },
      { key: "contact_hours_bn", label: "Business Hours (বাংলা)", placeholder: "শনি–বৃহঃ, সকাল ৯টা–রাত ৮টা" },
