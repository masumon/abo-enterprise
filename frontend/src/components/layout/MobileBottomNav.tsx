...
export default function MobileBottomNav() {
  ...
  return (
    <>
      <nav
        className="fixed inset-x-0 bottom-0 z-50 lg:hidden grid grid-cols-5 bg-white dark:bg-[var(--surface-card)] border-t border-[var(--line)] shadow-[0_-4px_16px_rgba(20,24,43,0.06)] dark:shadow-[0_-4px_16px_rgba(0,0,0,0.3)]"
