import { Facebook, Instagram, Twitter, Linkedin, Youtube, MessageCircle, Music2, type LucideIcon } from "lucide-react";
...
export const SOCIAL_PLATFORMS = [
  ...
  { code: "tiktok", name: "TikTok", icon: Music2, bgColor: "bg-neutral-900 hover:bg-black" },
];
...
export function SocialMediaLinks({
  ...
  const links: { href: string; icon: LucideIcon; label: string; bg: string }[] = [
    ...
    { href: tiktokUrl || "", icon: Music2, label: "TikTok", bg: "bg-neutral-900 hover:bg-black" },
