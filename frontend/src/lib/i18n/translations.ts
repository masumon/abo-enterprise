...
const translations = {
  en: {
    ...
    hero_tagline: "Accessories, Printing, Legal, Software",
    hero_title_1: "Everything Your",
    hero_title_2: "Business Needs",
    hero_title_3: "In One Place",
    hero_sub: "Mobile accessories, printing, legal help, digital services, AI & custom software — from Sylhet.",
  ...
  bn: {
    ...
    hero_tagline: "এক্সেসরিজ · প্রিন্টিং · আইনি · সফটওয়্যার",
    hero_title_1: "আপনার ব্যবসার",
    hero_title_2: "সব সমাধান",
    hero_title_3: "এক জায়গায়",
    hero_sub: "মোবাইল এক্সেসরিজ, প্রিন্টিং, আইনি সহায়তা, ডিজিটাল সেবা, AI ও কাস্টম সফটওয়্যার — সিলেট থেকে।",
