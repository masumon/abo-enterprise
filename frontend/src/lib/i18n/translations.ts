...
const translations = {
  en: {
    ...
    hero_tagline: "Unified Technology Business Platform",
    hero_title_1: "Everything Your",
    hero_title_2: "Business Needs",
    hero_title_3: "In One Place",
    hero_sub: "Premium tech store, digital service center, printing, software lab, business software, AI automation and custom development — from Sylhet.",
  ...
  bn: {
    ...
    hero_tagline: "সমন্বিত প্রযুক্তি ব্যবসায়িক প্ল্যাটফর্ম",
    hero_title_1: "আপনার ব্যবসার",
    hero_title_2: "সব সমাধান",
    hero_title_3: "এক জায়গায়",
    hero_sub: "প্রিমিয়াম টেক স্টোর, ডিজিটাল সার্ভিস সেন্টার, প্রিন্টিং, সফটওয়্যার ল্যাব, বিজনেস সফটওয়্যার, AI অটোমেশন ও কাস্টম ডেভেলপমেন্ট — সিলেট থেকে।",
