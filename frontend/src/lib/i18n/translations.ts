...
const translations = {
  en: {
    ...
    hero_sub: "Products, services, software & AI — one trusted enterprise platform.",
    ...
    assistant_welcome: "How can I help you today? Ask in English or Bangla — I'm here 24/7.",
  ...
  bn: {
    ...
    hero_sub: "পণ্য, সেবা, সফটওয়্যার ও AI — এক বিশ্বস্ত এন্টারপ্রাইজ প্ল্যাটফর্ম।",
    ...
    assistant_welcome: "আজ কীভাবে সাহায্য করতে পারি? ইংরেজি বা বাংলায় জিজ্ঞাসা করুন — আমি ২৪/৭ আছি।",
