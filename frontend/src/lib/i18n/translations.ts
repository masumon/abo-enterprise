...
const translations = {
  en: {
    ...
    hero_tagline: "Premium Tech Products, Digital Services & AI Business Solutions",
    hero_title_1: "Everything Your",
    hero_title_2: "Business Needs",
    hero_title_3: "In One Place",
    hero_sub: "Mobile Accessories • Digital Services • Mobile & Computer Software • POS • ERP • AI • Web Solutions",
  ...
  bn: {
    ...
    hero_tagline: "প্রিমিয়াম টেক প্রোডাক্ট, ডিজিটাল সেবা ও AI বিজনেস সলিউশন",
    hero_title_1: "আপনার ব্যবসার",
    hero_title_2: "সব সমাধান",
    hero_title_3: "এক জায়গায়",
    hero_sub: "মোবাইল এক্সেসরিজ • ডিজিটাল সেবা • মোবাইল ও কম্পিউটার সফটওয়্যার • POS • ERP • AI • ওয়েব সলিউশন",
