...
const translations = {
  en: {
    ...
    compare: "Compare",
    // Hero
    hero_badge: "Building Digital Future · Simple Solution",
    hero_brand: "ABO ENTERPRISE",
    hero_tagline: "Building Digital Future",
  ...
  bn: {
    ...
    wishlist: "উইশলিস্ট",
    compare: "তুলনা",
    hero_badge: "ডিজিটাল ভবিষ্যৎ গড়ি · সহজ সমাধান",
    hero_brand: "ABO ENTERPRISE",
    hero_tagline: "ডিজিটাল ভবিষ্যৎ গড়ি",
